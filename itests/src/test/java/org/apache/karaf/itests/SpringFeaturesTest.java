...
public class SpringFeaturesTest extends KarafTestSupport {
    ...
    // Spring 4.2.x features

    @Test
    public void testSpring42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringAspects42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-ASPECTS "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-aspects", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringInstrument42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-INSTRUMENT "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-instrument", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringJdbc42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-JDBC "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-jdbc", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringJms42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-JMS "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-jms", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringTest42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-TEST "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-test", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringOrm42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-ORM "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-orm", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringOxm42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-OXM "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-oxm", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringTx42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-TX "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-tx", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringWeb42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-WEB "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-web", System.getProperty("spring42.version"));
    }

    @Test
    public void testSpringWebPortlet42Feature() throws Exception {
        System.out.println("");
        System.out.println("===== TESTING SPRING-WEB-PORTLET "+ System.getProperty("spring42.version") + " FEATURE =====");
        installAndAssertFeature("spring-web-portlet", System.getProperty("spring42.version"));
    }
