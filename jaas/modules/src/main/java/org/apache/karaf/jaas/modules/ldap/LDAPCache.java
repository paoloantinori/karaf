...
public class LDAPCache {
    ...
    private static final ConcurrentMap<Map<String, ?>, LDAPCache> CACHES = new ConcurrentHashMap<Map<String, ?>, LDAPCache>();
    ...
    public LDAPCache(Map<String, ?> options) {
        ...
        userDnAndNamespace = new ExpiringMap<String, String[]>(timeToLive);
        userRoles = new ExpiringMap<String, String[]>(timeToLive);
    }
